...
(cd testproject/ && pybabel extract -F babelrc -k Label/text -k Resource/catchphrase -k Resource/dialogue -k Node2D/catchphrase -k Node2D/dialogue -k tr -o translations_new.pot .)
